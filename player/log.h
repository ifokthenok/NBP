...
#define LOGE(...)   printLog("ERROR", LOG_TAG, __VA_ARGS__)                  
#else
#define LOGE(...)
#endif

#if LOG_WARN >= LOG_LEVEL
#define LOGW(...)   printLog("WARN ", LOG_TAG, __VA_ARGS__)                  
#else
#define LOGW(...)
#endif 

#if LOG_INFO >= LOG_LEVEL
#define LOGI(...)   printLog("INFO ", LOG_TAG, __VA_ARGS__)                  
#else
#define LOGI(...)
#endif 

#if LOG_DEBUG >= LOG_LEVEL
#define LOGD(...)   printLog("DEBUG", LOG_TAG,  __VA_ARGS__)                  
#else
#define LOGD(...)
#endif
